        ...
        <div class="navbar-form navbar-left" role="search" act>
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button id="searchbtn" class="btn btn-default" onclick="onSearchClick('verified.php')">
        ...
        <table class="table table-hover table-striped">
          ...
          <tbody id="tablebody">
            ...
            count("items",array(
                         ...
                         $datebase=new medoo();
                         global $maxpage;
                         $maxpage=ceil($datebase->count("items",array("AND"=>array("from"=>1,"verified"=>1)))/20)-1;
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="post.php?referer=verified.php&action=edit" enctype="multipart/form-data">
