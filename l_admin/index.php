        ...
        <div class="navbar-form navbar-left" role="search" act>
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button id="searchbtn" class="btn btn-default" onclick="onSearchClick('index.php')">
        ...
        <table class="table table-hover table-striped">
          ...
          <tbody id="tablebody">
            ...
            count("items",array(
                         ...
                         $datebase=new medoo();
                         global $maxpage;
                         $maxpage=ceil($datebase->count("items",array("from"=>0))/20)-1;
            ...
            <0?0:$page;
              ...
              $maxpage?$maxpage:$page;
                          if (isset($_GET["col"]) && isset($_GET["key"])) {
                            ...
                            $where=array("LIMIT"=>array($page*20,20),"ORDER"=> $order,"from"=>0);
              }else{
                          if (isset($_GET["col"]) && isset($_GET["key"])) {
                            $col=trim($purifier->purify($_GET["col"]));
                            $key=trim($purifier->purify($_GET["key"]));
                            ...
                            ,"ORDER"=> $order);
                              ...
                              $where=array("LIMIT"=>20,"ORDER"=> $order,"from"=>0);
                        }
                        createTable($where);
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="post.php?referer=index.php&action=add" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>简要描述</label>
                      <input type="text" class="form-control" name="title" placeholder="简要描述" required>

                      <label>详细描述(非必须)</label>
                      <textarea class="form-control" rows="5" name="description" placeholder="详细描述"></textarea>

                      <label>认领处</label>
                      <input type="text" class="form-control" value="石头坞202" name="place" placeholder="认领处" required></textarea>

                    <label>拾取日期</label>
                    <input type="text" class="form-control" value="<?php echo date('Y-m-d');?>" name="lostdate" id="lostdate" placeholder="拾取日期" required></textarea>

                  <label>图片</label>
                  <input type="file" class="form-control" accept="image/*" name="uploadfile" required>
      ...
      <div class="modal fade" id="editModal" tabindex="-1" role="dialog" 
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="post.php?referer=index.php&action=edit" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <label>详细描述(非必须)</label>
                  <textarea class="form-control" rows="5" id="description" name="description" placeholder="详细描述"></textarea>
