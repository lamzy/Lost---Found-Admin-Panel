      ...
      <div class="navbar-form navbar-left" role="search" act>
        <div class="input-group">
            ...
            <span class="input-group-btn">
              <button id="searchbtn" class="btn btn-default" onclick="onSearchClick('index_cards.php')">
    ...
    <div class="col-sm-9">
      ...
      ?>
        <div class="panel panel-default">
          ...
          可以在此面板添加、修改、删除招领数据(卡类)<br />点击<b>列表头</b>可以进行排序，点击标题显示详细信息
          ...
          <table class="table table-hover table-striped"> 
            ...
            <tbody id="tablebody">
                   ...
                   <?php 
                         ...
                         $datebase=new medoo();
                         global $maxpage;
                         $maxpage=ceil($datebase->count("cards",array("from"=>0))/20)-1;
         ...
         aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                          <form method="POST" action="post.php?referer=index_cards.php&action=addcard">
                            <div class="form-group">
                              ...
                              <label>认领处</label>
                              <input type="text" value="石头坞202" class="form-control" name="place" placeholder="认领处" required>
                            	
                              <label>拾取日期</label>
                              <input type="text" class="form-control"  value="<?php echo date('Y-m-d');?>" name="lostdate" id="lostdate" placeholder="拾取日期" required>

                              <label>联系方式(非必须)</label>
                              <input type="text"  class="form-control"  name="contact" placeholder="联系方式">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" 
         aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                          <form method="POST" action="post.php?referer=index_cards.php&action=edit" enctype="multipart/form-data">
                            <div class="form-group">
                             ...
                             <label>姓名</label>
                              ...
                              <label>拾取日期</label>
                              <input type="text" class="form-control" name="lostdate" id="lostdate2" placeholder="拾取日期" required>
