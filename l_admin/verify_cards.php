      ...
      <div class="navbar-form navbar-left" role="search" act>
        <div class="input-group">
            ...
            <span class="input-group-btn">
              <button id="searchbtn" class="btn btn-default" onclick="onSearchClick('verify_cards.php')">
    ...
    <div class="col-sm-9">
      ...
      ?>
        <div class="panel panel-default">
          ...
          可以在此面板审核、删除招领数据(卡类)<br />点击<b>列表头</b>可以进行排序，点击标题显示详细信息
          </div>
            ...
            <tbody id="tablebody">
                   ...
                   <?php 
                          ...
                          $datebase=new medoo();
                             ...
                             "AND"=>array(($col."[~]")=>$key,"AND"=>array("from"=>1,"verified"=>0))
                            ))/20)-1;
                         ...
                         $datebase=new medoo();
                         global $maxpage;
                         $maxpage=ceil($datebase->count("cards",array("AND"=>array("from"=>1,"verified"=>0)))/20)-1;
         ...
         aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                          <form method="POST" action="post.php?referer=verify_cards.php&action=verifycard" enctype="multipart/form-data">
                            <div class="form-group">
                             ...
                             <label>姓名</label>
                              ...
                              <label>丢失日期</label>
                              <input type="text" class="form-control" name="lostdate" id="lostdate2" placeholder="丢失日期" required>
                             ...
                             <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-success" name="submit">审核数据</button>
                              </div>
                          </form>
