    ...
    <div class="timelincontainer">
      ...
      <div class="content">
        ...
        if (isset($_GET["col"]) && isset($_GET["key"])) {
          $where=array(
          "AND"=>
          array("verified"=>1,"from"=>$from,$_GET["col"]."[~]"=>$_GET["key"]),
    ...
    $(function(){
      ...
      var pullupAction = function(){
        ...
        if(typeof($col)=="undefined" || typeof($key)=="undefined")
          $col=$key="";
        $.getJSON('front_get.php', {table:"cards",from:1,page:page,pagesize:10,col:$col,key:$key}, function(json) {
              if (json.length>0) {
                $new=false;
